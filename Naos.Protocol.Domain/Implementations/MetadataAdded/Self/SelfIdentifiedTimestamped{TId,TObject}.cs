// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SelfIdentifiedTimestamped{TId,TObject}.cs" company="Naos Project">
...
namespace Naos.Protocol.Domain
{
    ...
    public partial class SelfIdentifiedTimestamped<TId, TObject> : IIdentifiableBy<TId>, IHaveTimestampUtc
        where TObject : IIdentifiableBy<TId>, IHaveTimestampUtc
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SelfIdentifiedTimestamped{TId, TObject}"/> class.
        /// </summary>
        /// <param name="object">The object.</param>
        public SelfIdentifiedTimestamped(
            TObject @object)
        {
            if (@object == null)
            {
