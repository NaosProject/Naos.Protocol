// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CanceledRequestedExecutionEvent{TId,TCancelContext}.cs" company="Naos Project">
...
namespace Naos.Protocol.Domain
{
    ...
    public partial class CanceledRequestedExecutionEvent<TId, TCancelContext> : EventWithTagsBase<TId>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CanceledRequestedExecutionEvent{TId, TCancelContext}"/> class.
        /// </summary>
