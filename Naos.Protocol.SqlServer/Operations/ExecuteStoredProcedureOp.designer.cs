...
namespace Naos.Protocol.SqlServer
{
    ...
    public partial class ExecuteStoredProcedureOp : IModel<ExecuteStoredProcedureOp>
    {
        ...
        /// <inheritdoc />
        protected override ReturningOperationBase<StoredProcedureExecutionResult> DeepCloneInternal()
        {
            var result = new ExecuteStoredProcedureOp(
                                 this.Name?.Clone().ToString(),
                                 this.ParameterNameToDetailsMap?.ToDictionary(k => k.Key?.Clone().ToString(), v => v.Value?.DeepClone()));
        ...
        {
            var result = Invariant($"Naos.Protocol.SqlServer.ExecuteStoredProcedureOp: Name = {this.Name?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, ParameterNameToDetailsMap = {this.ParameterNameToDetailsMap?.ToString() ?? "<null>"}.");
