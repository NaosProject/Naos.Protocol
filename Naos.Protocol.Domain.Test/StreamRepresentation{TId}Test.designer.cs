...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<StreamRepresentation<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<StreamRepresentation<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<StreamRepresentation<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<StreamRepresentation<Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<StreamRepresentation<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.StreamRepresentation<Version>: Name = {systemUnderTest.Name?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<StreamRepresentation<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<StreamRepresentation<Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<StreamRepresentation<Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'name' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new StreamRepresentation<Version>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<StreamRepresentation<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<StreamRepresentation<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<StreamRepresentation<Version>>
                {
                    Name = "Name should return same 'name' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<StreamRepresentation<Version>>();

                        var result = new SystemUnderTestExpectedPropertyValue<StreamRepresentation<Version>>
                        {
                            SystemUnderTest = new StreamRepresentation<Version>(
        ...
        private static readonly DeepCloneWithTestScenarios<StreamRepresentation<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<StreamRepresentation<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<StreamRepresentation<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<StreamRepresentation<Version>>().ThatIs(_ => !systemUnderTest.Name.IsEqualTo(_.Name));

                        var result = new SystemUnderTestDeepCloneWithValue<StreamRepresentation<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly StreamRepresentation<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<StreamRepresentation<Version>>();

        private static readonly EquatableTestScenarios<StreamRepresentation<Version>> EquatableTestScenarios = new EquatableTestScenarios<StreamRepresentation<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<StreamRepresentation<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new StreamRepresentation<Version>[]
                    {
                        new StreamRepresentation<Version>(
                                ReferenceObjectForEquatableTestScenarios.Name),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new StreamRepresentation<Version>[]
                    {
                        new StreamRepresentation<Version>(
                                A.Dummy<StreamRepresentation<Version>>().Whose(_ => !_.Name.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Name)).Name),
                    },
        ...
        public static class Structural
        {
            ...
            public static void StreamRepresentation___Should_implement_IModel_of_StreamRepresentation___When_reflecting()
            {
                // Arrange
                var type = typeof(StreamRepresentation<Version>);

                var expectedModelMethods = typeof(IModel<StreamRepresentation<Version>>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<StreamRepresentation<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void StreamRepresentation___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(StreamRepresentation<Version>);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (StreamRepresentation<Version>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (StreamRepresentation<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(StreamRepresentation<Version>).GetProperty(propertyName);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<StreamRepresentation<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                StreamRepresentation<Version> systemUnderTest1 = null;
                StreamRepresentation<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    StreamRepresentation<Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StreamRepresentation___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StreamRepresentation___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StreamRepresentation___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StreamRepresentation___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_StreamRepresentation___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
