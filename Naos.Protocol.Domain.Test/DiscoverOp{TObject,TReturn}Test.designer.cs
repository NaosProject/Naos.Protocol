...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<DiscoverOp<Version, Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<DiscoverOp<Version, Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<DiscoverOp<Version, Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<DiscoverOp<Version, Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<DiscoverOp<Version, Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.DiscoverOp<Version, Version>: OperationId = {systemUnderTest.OperationId?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<DiscoverOp<Version, Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<DiscoverOp<Version, Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<DiscoverOp<Version, Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'operationId' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new DiscoverOp<Version, Version>(
                                             null);

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "operationId" },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<DiscoverOp<Version, Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<DiscoverOp<Version, Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<DiscoverOp<Version, Version>>
                {
                    Name = "OperationId should return same 'operationId' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<DiscoverOp<Version, Version>>();

                        var result = new SystemUnderTestExpectedPropertyValue<DiscoverOp<Version, Version>>
                        {
                            SystemUnderTest = new DiscoverOp<Version, Version>(
                                                      referenceObject.OperationId),
                            ExpectedPropertyValue = referenceObject.OperationId,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<DiscoverOp<Version, Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<DiscoverOp<Version, Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DiscoverOp<Version, Version>>
                {
                    Name = "DeepCloneWithOperationId should deep clone object and replace OperationId with the provided operationId",
                    WithPropertyName = "OperationId",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<DiscoverOp<Version, Version>>();

                        var referenceObject = A.Dummy<DiscoverOp<Version, Version>>().ThatIs(_ => !systemUnderTest.OperationId.IsEqualTo(_.OperationId));

                        var result = new SystemUnderTestDeepCloneWithValue<DiscoverOp<Version, Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.OperationId,
                        };
        ...
        private static readonly DiscoverOp<Version, Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<DiscoverOp<Version, Version>>();

        private static readonly EquatableTestScenarios<DiscoverOp<Version, Version>> EquatableTestScenarios = new EquatableTestScenarios<DiscoverOp<Version, Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<DiscoverOp<Version, Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new DiscoverOp<Version, Version>[]
                    {
                        new DiscoverOp<Version, Version>(
                                ReferenceObjectForEquatableTestScenarios.OperationId),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new DiscoverOp<Version, Version>[]
                    {
                        new DiscoverOp<Version, Version>(
                                A.Dummy<DiscoverOp<Version, Version>>().Whose(_ => !_.OperationId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.OperationId)).OperationId),
                    },
        ...
        public static class Structural
        {
            ...
            public static void DiscoverOp___Should_implement_IModel_of_DiscoverOp___When_reflecting()
            {
                // Arrange
                var type = typeof(DiscoverOp<Version, Version>);

                var expectedModelMethods = typeof(IModel<DiscoverOp<Version, Version>>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<DiscoverOp<Version, Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void DiscoverOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(DiscoverOp<Version, Version>);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (DiscoverOp<Version, Version>)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.OperationId == null)
                {
                    actual.OperationId.AsTest().Must().BeNull();
                }
                else
                {
                    actual.OperationId.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.OperationId);
                }
            }
            ...
            {
                var propertyNames = new string[] { "OperationId" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (DiscoverOp<Version, Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(DiscoverOp<Version, Version>).GetProperty(propertyName);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<DiscoverOp<Version, Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                DiscoverOp<Version, Version> systemUnderTest1 = null;
                DiscoverOp<Version, Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    DiscoverOp<Version, Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DiscoverOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DiscoverOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DiscoverOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DiscoverOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DiscoverOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
