...
namespace Naos.Protocol.SqlServer
{
    ...
    public partial class DecimalSqlDataTypeRepresentation : IModel<DecimalSqlDataTypeRepresentation>
    {
        ...
        {
            var result = Invariant($"Naos.Protocol.SqlServer.DecimalSqlDataTypeRepresentation: Precision = {this.Precision.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Scale = {this.Scale.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
