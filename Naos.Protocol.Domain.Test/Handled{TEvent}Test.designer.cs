...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Handled<Block>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Handled<Block>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Handled<Block>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Handled<Block>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Handled<Block>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.Handled<Block>: HandledEvent = {systemUnderTest.HandledEvent?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Handled<Block>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Handled<Block>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Handled<Block>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'handledEvent' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new Handled<Block>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Handled<Block>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Handled<Block>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Handled<Block>>
                {
                    Name = "HandledEvent should return same 'handledEvent' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Handled<Block>>();

                        var result = new SystemUnderTestExpectedPropertyValue<Handled<Block>>
                        {
                            SystemUnderTest = new Handled<Block>(
        ...
        private static readonly DeepCloneWithTestScenarios<Handled<Block>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Handled<Block>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Handled<Block>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Handled<Block>>().ThatIs(_ => !systemUnderTest.HandledEvent.IsEqualTo(_.HandledEvent));

                        var result = new SystemUnderTestDeepCloneWithValue<Handled<Block>>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly Handled<Block> ReferenceObjectForEquatableTestScenarios = A.Dummy<Handled<Block>>();

        private static readonly EquatableTestScenarios<Handled<Block>> EquatableTestScenarios = new EquatableTestScenarios<Handled<Block>>()
            .AddScenario(() =>
                new EquatableTestScenario<Handled<Block>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Handled<Block>[]
                    {
                        new Handled<Block>(
                                ReferenceObjectForEquatableTestScenarios.HandledEvent),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new Handled<Block>[]
                    {
                        new Handled<Block>(
                                A.Dummy<Handled<Block>>().Whose(_ => !_.HandledEvent.IsEqualTo(ReferenceObjectForEquatableTestScenarios.HandledEvent)).HandledEvent),
                    },
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(Handled<Block>);

                var expectedModelMethods = typeof(IModel<Handled<Block>>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Handled<Block>>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Handled<Block>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Handled<Block>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(Handled<Block>).GetProperty(propertyName);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<Handled<Block>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                Handled<Block> systemUnderTest1 = null;
                Handled<Block> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    Handled<Block> systemUnderTest = null;
