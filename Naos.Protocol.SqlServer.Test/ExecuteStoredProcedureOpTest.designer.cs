    ...
    public static partial class ExecuteStoredProcedureOpTest
    {
                ...
                new StringRepresentationTestScenario<ExecuteStoredProcedureOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<ExecuteStoredProcedureOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.SqlServer.ExecuteStoredProcedureOp: Name = {systemUnderTest.Name?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, ParameterNameToDetailsMap = {systemUnderTest.ParameterNameToDetailsMap?.ToString() ?? "<null>"}."),
                        };
        ...
        public static class Structural
        {
            ...
            public static void ExecuteStoredProcedureOp___Should_implement_IModel_of_ExecuteStoredProcedureOp___When_reflecting()
            {
                ...
                var expectedModelMethods = typeof(IModel<ExecuteStoredProcedureOp>)
        ...
        public static class Cloning
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var property = typeof(ExecuteStoredProcedureOp).GetProperty(propertyName);
