...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Pruning> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Pruning>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Pruning>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Pruning>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Pruning>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.Pruning: Pruner = {systemUnderTest.Pruner?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Pruning> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Pruning>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Pruning>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'pruner' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new Pruning(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Pruning> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Pruning>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Pruning>
                {
                    Name = "Pruner should return same 'pruner' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Pruning>();

                        var result = new SystemUnderTestExpectedPropertyValue<Pruning>
                        {
                            SystemUnderTest = new Pruning(
        ...
        private static readonly DeepCloneWithTestScenarios<Pruning> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Pruning>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Pruning>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Pruning>().ThatIs(_ => !systemUnderTest.Pruner.IsEqualTo(_.Pruner));

                        var result = new SystemUnderTestDeepCloneWithValue<Pruning>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly Pruning ReferenceObjectForEquatableTestScenarios = A.Dummy<Pruning>();

        private static readonly EquatableTestScenarios<Pruning> EquatableTestScenarios = new EquatableTestScenarios<Pruning>()
            .AddScenario(() =>
                new EquatableTestScenario<Pruning>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Pruning[]
                    {
                        new Pruning(
                                ReferenceObjectForEquatableTestScenarios.Pruner),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new Pruning[]
                    {
                        new Pruning(
                                A.Dummy<Pruning>().Whose(_ => !_.Pruner.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Pruner)).Pruner),
                    },
        ...
        public static class Structural
        {
            ...
            public static void Pruning___Should_implement_IModel_of_Pruning___When_reflecting()
            {
                // Arrange
                var type = typeof(Pruning);

                var expectedModelMethods = typeof(IModel<Pruning>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Pruning>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Pruning___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(Pruning);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Pruning)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Pruner" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Pruning)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(Pruning).GetProperty(propertyName);
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                Pruning systemUnderTest1 = null;
                Pruning systemUnderTest2 = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Pruning___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Pruning___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Pruning___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Pruning___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Pruning___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
