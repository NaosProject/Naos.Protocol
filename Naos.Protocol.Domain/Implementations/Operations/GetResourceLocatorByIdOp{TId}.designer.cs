...
namespace Naos.Protocol.Domain
{
    ...
    public partial class GetResourceLocatorByIdOp<TId> : IModel<GetResourceLocatorByIdOp<TId>>
    {
        ...
        /// <inheritdoc />
        protected override ReturningOperationBase<IResourceLocator> DeepCloneInternal()
        {
            var result = new GetResourceLocatorByIdOp<TId>(
        ...
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", Justification = NaosSuppressBecause.CA_ALL_AgreeWithAssessmentAndNeedsRefactoring)]
