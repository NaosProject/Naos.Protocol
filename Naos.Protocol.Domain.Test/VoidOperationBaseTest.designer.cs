...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly VoidOperationBase ReferenceObjectForEquatableTestScenarios = A.Dummy<VoidOperationBase>();

        private static readonly EquatableTestScenarios<VoidOperationBase> EquatableTestScenarios = new EquatableTestScenarios<VoidOperationBase>()
            .AddScenario(() =>
                new EquatableTestScenario<VoidOperationBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new VoidOperationBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new VoidOperationBase[]
                    {
                    ...
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new VoidOperationBase[]
                    {
                        A.Dummy<VoidOperationBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void VoidOperationBase___Should_implement_IModel_of_VoidOperationBase___When_reflecting()
            {
                // Arrange
                var type = typeof(VoidOperationBase);

                var expectedModelMethods = typeof(IModel<VoidOperationBase>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<VoidOperationBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void VoidOperationBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(VoidOperationBase);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<VoidOperationBase>();

                // Act
                var actual = (VoidOperationBase)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<VoidOperationBase>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                VoidOperationBase systemUnderTest1 = null;
                VoidOperationBase systemUnderTest2 = null;
