...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly EventWithTagsBase<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<EventWithTagsBase<Version>>();

        private static readonly EquatableTestScenarios<EventWithTagsBase<Version>> EquatableTestScenarios = new EquatableTestScenarios<EventWithTagsBase<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<EventWithTagsBase<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new EventWithTagsBase<Version>[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new EventWithTagsBase<Version>[]
                    {
                    ...
                    {
                        A.Dummy<EventWithTagsBase<Version>>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void EventWithTagsBase___Should_implement_IModel_of_EventWithTagsBase___When_reflecting()
            {
                // Arrange
                var type = typeof(EventWithTagsBase<Version>);

                var expectedModelMethods = typeof(IModel<EventWithTagsBase<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<EventWithTagsBase<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void EventWithTagsBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(EventWithTagsBase<Version>);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<EventWithTagsBase<Version>>();

                // Act
                var actual = (EventWithTagsBase<Version>)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<EventWithTagsBase<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                EventWithTagsBase<Version> systemUnderTest1 = null;
                EventWithTagsBase<Version> systemUnderTest2 = null;
