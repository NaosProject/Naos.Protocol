...
namespace Naos.Protocol.Domain.Test
{
    ...
    public static partial class GetOrAddCachedItemOpTOperationTReturnTest
    {
        private static readonly StringRepresentationTestScenarios<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>: Operation = {systemUnderTest.Operation?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'operation' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>
                {
                    Name = "Operation should return same 'operation' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>();

                        var result = new SystemUnderTestExpectedPropertyValue<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>
                        {
                            SystemUnderTest = new GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>(
        ...
        private static readonly DeepCloneWithTestScenarios<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>().ThatIs(_ => !systemUnderTest.Operation.IsEqualTo(_.Operation));

                        var result = new SystemUnderTestDeepCloneWithValue<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>();

        private static readonly EquatableTestScenarios<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>> EquatableTestScenarios = new EquatableTestScenarios<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>[]
                    {
                        new GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>(
                                ReferenceObjectForEquatableTestScenarios.Operation),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>[]
                    {
                        new GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>(
                                A.Dummy<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>().Whose(_ => !_.Operation.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Operation)).Operation),
                    },
                    ObjectsThatAreNotOfTheSameTypeAsReferenceObject = new object[]
                    {
                        ...
                        A.Dummy<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>(),
        ...
        public static class Structural
        {
            ...
            public static void GetOrAddCachedItemOp___Should_implement_IModel_of_GetOrAddCachedItemOp___When_reflecting()
            {
                // Arrange
                var type = typeof(GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>);

                var expectedModelMethods = typeof(IModel<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void GetOrAddCachedItemOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version> systemUnderTest1 = null;
                GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    GetOrAddCachedItemOp<GetIdFromObjectOp<Version, Version>, Version> systemUnderTest = null;
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_null()
            {
                ...
                {
                    // Arrange
                    ReturningOperationBase<CacheResult<GetIdFromObjectOp<Version, Version>, Version>> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<CacheResult<GetIdFromObjectOp<Version, Version>, Version>>)systemUnderTest);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_parameter_other_is_same_object()
            {
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<CacheResult<GetIdFromObjectOp<Version, Version>, Version>>)scenario.ReferenceObject);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<CacheResult<GetIdFromObjectOp<Version, Version>, Version>>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<CacheResult<GetIdFromObjectOp<Version, Version>, Version>>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<CacheResult<GetIdFromObjectOp<Version, Version>, Version>>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetOrAddCachedItemOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetOrAddCachedItemOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetOrAddCachedItemOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetOrAddCachedItemOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetOrAddCachedItemOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
