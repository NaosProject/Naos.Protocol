...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Handling<CancelBlock>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Handling<CancelBlock>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Handling<CancelBlock>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Handling<CancelBlock>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Handling<CancelBlock>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.Handling<CancelBlock>: HandledEvent = {systemUnderTest.HandledEvent?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Handling<CancelBlock>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Handling<CancelBlock>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Handling<CancelBlock>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'handledEvent' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new Handling<CancelBlock>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Handling<CancelBlock>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Handling<CancelBlock>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Handling<CancelBlock>>
                {
                    Name = "HandledEvent should return same 'handledEvent' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Handling<CancelBlock>>();

                        var result = new SystemUnderTestExpectedPropertyValue<Handling<CancelBlock>>
                        {
                            SystemUnderTest = new Handling<CancelBlock>(
        ...
        private static readonly DeepCloneWithTestScenarios<Handling<CancelBlock>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Handling<CancelBlock>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Handling<CancelBlock>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Handling<CancelBlock>>().ThatIs(_ => !systemUnderTest.HandledEvent.IsEqualTo(_.HandledEvent));

                        var result = new SystemUnderTestDeepCloneWithValue<Handling<CancelBlock>>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly Handling<CancelBlock> ReferenceObjectForEquatableTestScenarios = A.Dummy<Handling<CancelBlock>>();

        private static readonly EquatableTestScenarios<Handling<CancelBlock>> EquatableTestScenarios = new EquatableTestScenarios<Handling<CancelBlock>>()
            .AddScenario(() =>
                new EquatableTestScenario<Handling<CancelBlock>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Handling<CancelBlock>[]
                    {
                        new Handling<CancelBlock>(
                                ReferenceObjectForEquatableTestScenarios.HandledEvent),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new Handling<CancelBlock>[]
                    {
                        new Handling<CancelBlock>(
                                A.Dummy<Handling<CancelBlock>>().Whose(_ => !_.HandledEvent.IsEqualTo(ReferenceObjectForEquatableTestScenarios.HandledEvent)).HandledEvent),
                    },
        ...
        public static class Structural
        {
            ...
            public static void Handling___Should_implement_IModel_of_Handling___When_reflecting()
            {
                // Arrange
                var type = typeof(Handling<CancelBlock>);

                var expectedModelMethods = typeof(IModel<Handling<CancelBlock>>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Handling<CancelBlock>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Handling___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(Handling<CancelBlock>);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Handling<CancelBlock>)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "HandledEvent" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Handling<CancelBlock>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(Handling<CancelBlock>).GetProperty(propertyName);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<Handling<CancelBlock>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                Handling<CancelBlock> systemUnderTest1 = null;
                Handling<CancelBlock> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    Handling<CancelBlock> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Handling___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Handling___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Handling___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Handling___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Handling___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
