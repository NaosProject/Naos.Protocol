    ...
    public static partial class RecordedObjectEventTIdTObjectTest
    {
                ...
                new StringRepresentationTestScenario<RecordedObjectEvent<Version, Version>>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<RecordedObjectEvent<Version, Version>>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.RecordedObjectEvent<Version, Version>: Id = {systemUnderTest.Id?.ToString() ?? "<null>"}, TimestampUtc = {systemUnderTest.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, CreatedObject = {systemUnderTest.CreatedObject?.ToString() ?? "<null>"}, Tags = {systemUnderTest.Tags?.ToString() ?? "<null>"}."),
                        };
        ...
        public static class Structural
        {
            ...
            public static void RecordedObjectEvent___Should_implement_IModel_of_RecordedObjectEvent___When_reflecting()
            {
                ...
                var expectedModelMethods = typeof(IModel<RecordedObjectEvent<Version, Version>>).GetInterfaceDeclaredAndImplementedMethods();
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Id", "TimestampUtc", "CreatedObject", "Tags" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var propertyInfo = typeof(RecordedObjectEvent<Version, Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
