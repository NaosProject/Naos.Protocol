...
namespace Naos.Protocol.SqlServer
{
    ...
    public partial class BinarySqlDataTypeRepresentation : IModel<BinarySqlDataTypeRepresentation>
    {
        ...
        {
            var result = Invariant($"Naos.Protocol.SqlServer.BinarySqlDataTypeRepresentation: SupportedLength = {this.SupportedLength.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
