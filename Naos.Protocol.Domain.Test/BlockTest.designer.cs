...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Block> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Block>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Block>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Block>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Block>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.Block: Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Block> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Block>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Block>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Block> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Block>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Block>
                {
                    Name = "Details should return same 'details' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Block>();

                        var result = new SystemUnderTestExpectedPropertyValue<Block>
                        {
                            SystemUnderTest = new Block(
        ...
        private static readonly DeepCloneWithTestScenarios<Block> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Block>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Block>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Block>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));

                        var result = new SystemUnderTestDeepCloneWithValue<Block>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly Block ReferenceObjectForEquatableTestScenarios = A.Dummy<Block>();

        private static readonly EquatableTestScenarios<Block> EquatableTestScenarios = new EquatableTestScenarios<Block>()
            .AddScenario(() =>
                new EquatableTestScenario<Block>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Block[]
                    {
                        new Block(
                                ReferenceObjectForEquatableTestScenarios.Details),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new Block[]
                    {
                        new Block(
                                A.Dummy<Block>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details),
                    },
        ...
        public static class Structural
        {
            ...
            public static void Block___Should_implement_IModel_of_Block___When_reflecting()
            {
                // Arrange
                var type = typeof(Block);

                var expectedModelMethods = typeof(IModel<Block>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Block>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Block___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(Block);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Block)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Block)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(Block).GetProperty(propertyName);
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                Block systemUnderTest1 = null;
                Block systemUnderTest2 = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Block___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Block___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Block___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Block___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Block___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
