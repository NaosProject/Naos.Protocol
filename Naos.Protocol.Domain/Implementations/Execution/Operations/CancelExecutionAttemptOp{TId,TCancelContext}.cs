// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CancelExecutionAttemptOp{TId,TCancelContext}.cs" company="Naos Project">
...
namespace Naos.Protocol.Domain
{
    ...
    public partial class CancelExecutionAttemptOp<TId, TCancelContext> : VoidOperationBase, IIdentifiableBy<TId>, IHaveTags
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelExecutionAttemptOp{TId,TOperation}"/> class.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <param name="cancelContext">The context of the cancellation.</param>
        /// <param name="tags">The optional tags.</param>
        public CancelExecutionAttemptOp(
            TId id,
