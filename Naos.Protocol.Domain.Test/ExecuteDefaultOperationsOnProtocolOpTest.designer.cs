...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ExecuteDefaultOperationsOnProtocolOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ExecuteDefaultOperationsOnProtocolOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ExecuteDefaultOperationsOnProtocolOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ExecuteDefaultOperationsOnProtocolOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<ExecuteDefaultOperationsOnProtocolOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.ExecuteDefaultOperationsOnProtocolOp: Context = {systemUnderTest.Context?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ExecuteDefaultOperationsOnProtocolOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ExecuteDefaultOperationsOnProtocolOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ExecuteDefaultOperationsOnProtocolOp>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ExecuteDefaultOperationsOnProtocolOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ExecuteDefaultOperationsOnProtocolOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ExecuteDefaultOperationsOnProtocolOp>
                {
                    Name = "Context should return same 'context' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ExecuteDefaultOperationsOnProtocolOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<ExecuteDefaultOperationsOnProtocolOp>
                        {
                            SystemUnderTest = new ExecuteDefaultOperationsOnProtocolOp(
        ...
        private static readonly DeepCloneWithTestScenarios<ExecuteDefaultOperationsOnProtocolOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ExecuteDefaultOperationsOnProtocolOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ExecuteDefaultOperationsOnProtocolOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ExecuteDefaultOperationsOnProtocolOp>().ThatIs(_ => !systemUnderTest.Context.IsEqualTo(_.Context));

                        var result = new SystemUnderTestDeepCloneWithValue<ExecuteDefaultOperationsOnProtocolOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly ExecuteDefaultOperationsOnProtocolOp ReferenceObjectForEquatableTestScenarios = A.Dummy<ExecuteDefaultOperationsOnProtocolOp>();

        private static readonly EquatableTestScenarios<ExecuteDefaultOperationsOnProtocolOp> EquatableTestScenarios = new EquatableTestScenarios<ExecuteDefaultOperationsOnProtocolOp>()
            .AddScenario(() =>
                new EquatableTestScenario<ExecuteDefaultOperationsOnProtocolOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ExecuteDefaultOperationsOnProtocolOp[]
                    {
                        new ExecuteDefaultOperationsOnProtocolOp(
                                ReferenceObjectForEquatableTestScenarios.Context),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ExecuteDefaultOperationsOnProtocolOp[]
                    {
                        new ExecuteDefaultOperationsOnProtocolOp(
                                A.Dummy<ExecuteDefaultOperationsOnProtocolOp>().Whose(_ => !_.Context.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Context)).Context),
                    },
        ...
        public static class Structural
        {
            ...
            public static void ExecuteDefaultOperationsOnProtocolOp___Should_implement_IModel_of_ExecuteDefaultOperationsOnProtocolOp___When_reflecting()
            {
                // Arrange
                var type = typeof(ExecuteDefaultOperationsOnProtocolOp);

                var expectedModelMethods = typeof(IModel<ExecuteDefaultOperationsOnProtocolOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ExecuteDefaultOperationsOnProtocolOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ExecuteDefaultOperationsOnProtocolOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ExecuteDefaultOperationsOnProtocolOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ExecuteDefaultOperationsOnProtocolOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ExecuteDefaultOperationsOnProtocolOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ExecuteDefaultOperationsOnProtocolOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ExecuteDefaultOperationsOnProtocolOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                ExecuteDefaultOperationsOnProtocolOp systemUnderTest1 = null;
                ExecuteDefaultOperationsOnProtocolOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ExecuteDefaultOperationsOnProtocolOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExecuteDefaultOperationsOnProtocolOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExecuteDefaultOperationsOnProtocolOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExecuteDefaultOperationsOnProtocolOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExecuteDefaultOperationsOnProtocolOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExecuteDefaultOperationsOnProtocolOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
