...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CancelExecutionRequestOp<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CancelExecutionRequestOp<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CancelExecutionRequestOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CancelExecutionRequestOp<Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CancelExecutionRequestOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.CancelExecutionRequestOp<Version>: Id = {systemUnderTest.Id?.ToString() ?? "<null>"}, Tags = {systemUnderTest.Tags?.ToString() ?? "<null>"}, Details = {systemUnderTest.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CancelExecutionRequestOp<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CancelExecutionRequestOp<Version>>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CancelExecutionRequestOp<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CancelExecutionRequestOp<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CancelExecutionRequestOp<Version>>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CancelExecutionRequestOp<Version>>
                        {
                            SystemUnderTest = new CancelExecutionRequestOp<Version>(
                                                      referenceObject.Id,
                                                      referenceObject.Details,
                                                      referenceObject.Tags),
        ...
        private static readonly DeepCloneWithTestScenarios<CancelExecutionRequestOp<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CancelExecutionRequestOp<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CancelExecutionRequestOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CancelExecutionRequestOp<Version>>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<CancelExecutionRequestOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CancelExecutionRequestOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CancelExecutionRequestOp<Version>>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CancelExecutionRequestOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CancelExecutionRequestOp<Version>>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
        ...
        private static readonly CancelExecutionRequestOp<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<CancelExecutionRequestOp<Version>>();

        private static readonly EquatableTestScenarios<CancelExecutionRequestOp<Version>> EquatableTestScenarios = new EquatableTestScenarios<CancelExecutionRequestOp<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<CancelExecutionRequestOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CancelExecutionRequestOp<Version>[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new CancelExecutionRequestOp<Version>[]
                    {
                        new CancelExecutionRequestOp<Version>(
                                A.Dummy<CancelExecutionRequestOp<Version>>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new CancelExecutionRequestOp<Version>(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Details,
                                A.Dummy<CancelExecutionRequestOp<Version>>().Whose(_ => !_.Tags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Tags)).Tags),
                        new CancelExecutionRequestOp<Version>(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<CancelExecutionRequestOp<Version>>().Whose(_ => !_.Details.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Details)).Details,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                    },
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(CancelExecutionRequestOp<Version>);

                var expectedModelMethods = typeof(IModel<CancelExecutionRequestOp<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CancelExecutionRequestOp<Version>>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CancelExecutionRequestOp<Version>)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Id", "Tags", "Details" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CancelExecutionRequestOp<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CancelExecutionRequestOp<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CancelExecutionRequestOp<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CancelExecutionRequestOp<Version> systemUnderTest1 = null;
                CancelExecutionRequestOp<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CancelExecutionRequestOp<Version> systemUnderTest = null;
