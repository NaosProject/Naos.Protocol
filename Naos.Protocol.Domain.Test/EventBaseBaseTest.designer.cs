...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly EventBaseBase ReferenceObjectForEquatableTestScenarios = A.Dummy<EventBaseBase>();

        private static readonly EquatableTestScenarios<EventBaseBase> EquatableTestScenarios = new EquatableTestScenarios<EventBaseBase>()
            .AddScenario(() =>
                new EquatableTestScenario<EventBaseBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new EventBaseBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new EventBaseBase[]
                    {
                        ...
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithTimestampUtc(A.Dummy<EventBaseBase>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc),
                    },
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new EventBaseBase[]
                    {
                        A.Dummy<EventBaseBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void EventBaseBase___Should_implement_IModel_of_EventBaseBase___When_reflecting()
            {
                // Arrange
                var type = typeof(EventBaseBase);

                var expectedModelMethods = typeof(IModel<EventBaseBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<EventBaseBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void EventBaseBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(EventBaseBase);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<EventBaseBase>();

                // Act
                var actual = (EventBaseBase)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<EventBaseBase>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                EventBaseBase systemUnderTest1 = null;
                EventBaseBase systemUnderTest2 = null;
