...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<GetIdFromObjectOp<Version, Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<GetIdFromObjectOp<Version, Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<GetIdFromObjectOp<Version, Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<GetIdFromObjectOp<Version, Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<GetIdFromObjectOp<Version, Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.GetIdFromObjectOp<Version, Version>: ObjectToDetermineIdFrom = {systemUnderTest.ObjectToDetermineIdFrom?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<GetIdFromObjectOp<Version, Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<GetIdFromObjectOp<Version, Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<GetIdFromObjectOp<Version, Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'objectToDetermineIdFrom' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new GetIdFromObjectOp<Version, Version>(
                                             null);

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "objectToDetermineIdFrom", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<GetIdFromObjectOp<Version, Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<GetIdFromObjectOp<Version, Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<GetIdFromObjectOp<Version, Version>>
                {
                    Name = "ObjectToDetermineIdFrom should return same 'objectToDetermineIdFrom' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<GetIdFromObjectOp<Version, Version>>();

                        var result = new SystemUnderTestExpectedPropertyValue<GetIdFromObjectOp<Version, Version>>
                        {
                            SystemUnderTest = new GetIdFromObjectOp<Version, Version>(
                                                      referenceObject.ObjectToDetermineIdFrom),
                            ExpectedPropertyValue = referenceObject.ObjectToDetermineIdFrom,
                        };

                        return result;
                    },
                    PropertyName = "ObjectToDetermineIdFrom",
                });

        private static readonly DeepCloneWithTestScenarios<GetIdFromObjectOp<Version, Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<GetIdFromObjectOp<Version, Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetIdFromObjectOp<Version, Version>>
                {
                    Name = "DeepCloneWithObjectToDetermineIdFrom should deep clone object and replace ObjectToDetermineIdFrom with the provided objectToDetermineIdFrom",
                    WithPropertyName = "ObjectToDetermineIdFrom",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<GetIdFromObjectOp<Version, Version>>();

                        var referenceObject = A.Dummy<GetIdFromObjectOp<Version, Version>>().ThatIs(_ => !systemUnderTest.ObjectToDetermineIdFrom.IsEqualTo(_.ObjectToDetermineIdFrom));

                        var result = new SystemUnderTestDeepCloneWithValue<GetIdFromObjectOp<Version, Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ObjectToDetermineIdFrom,
                        };
        ...
        private static readonly GetIdFromObjectOp<Version, Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<GetIdFromObjectOp<Version, Version>>();

        private static readonly EquatableTestScenarios<GetIdFromObjectOp<Version, Version>> EquatableTestScenarios = new EquatableTestScenarios<GetIdFromObjectOp<Version, Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<GetIdFromObjectOp<Version, Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new GetIdFromObjectOp<Version, Version>[]
                    {
                        new GetIdFromObjectOp<Version, Version>(
                                ReferenceObjectForEquatableTestScenarios.ObjectToDetermineIdFrom),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new GetIdFromObjectOp<Version, Version>[]
                    {
                        new GetIdFromObjectOp<Version, Version>(
                                A.Dummy<GetIdFromObjectOp<Version, Version>>().Whose(_ => !_.ObjectToDetermineIdFrom.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ObjectToDetermineIdFrom)).ObjectToDetermineIdFrom),
                    },
        ...
        public static class Structural
        {
            ...
            public static void GetIdFromObjectOp___Should_implement_IModel_of_GetIdFromObjectOp___When_reflecting()
            {
                // Arrange
                var type = typeof(GetIdFromObjectOp<Version, Version>);

                var expectedModelMethods = typeof(IModel<GetIdFromObjectOp<Version, Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<GetIdFromObjectOp<Version, Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void GetIdFromObjectOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(GetIdFromObjectOp<Version, Version>);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (GetIdFromObjectOp<Version, Version>)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.ObjectToDetermineIdFrom == null)
                {
                    actual.ObjectToDetermineIdFrom.AsTest().Must().BeNull();
                }
                else
                {
                    actual.ObjectToDetermineIdFrom.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.ObjectToDetermineIdFrom);
                }
            }
            ...
            {
                var propertyNames = new string[] { "ObjectToDetermineIdFrom" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (GetIdFromObjectOp<Version, Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(GetIdFromObjectOp<Version, Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<GetIdFromObjectOp<Version, Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                GetIdFromObjectOp<Version, Version> systemUnderTest1 = null;
                GetIdFromObjectOp<Version, Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    GetIdFromObjectOp<Version, Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetIdFromObjectOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetIdFromObjectOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetIdFromObjectOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetIdFromObjectOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetIdFromObjectOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
