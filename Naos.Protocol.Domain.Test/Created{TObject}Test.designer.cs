...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Created<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Created<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Created<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Created<Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Created<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.Created<Version>: CreatedObject = {systemUnderTest.CreatedObject?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Created<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Created<Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Created<Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'createdObject' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new Created<Version>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Created<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Created<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Created<Version>>
                {
                    Name = "CreatedObject should return same 'createdObject' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Created<Version>>();

                        var result = new SystemUnderTestExpectedPropertyValue<Created<Version>>
                        {
                            SystemUnderTest = new Created<Version>(
        ...
        private static readonly DeepCloneWithTestScenarios<Created<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Created<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Created<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Created<Version>>().ThatIs(_ => !systemUnderTest.CreatedObject.IsEqualTo(_.CreatedObject));

                        var result = new SystemUnderTestDeepCloneWithValue<Created<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly Created<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<Created<Version>>();

        private static readonly EquatableTestScenarios<Created<Version>> EquatableTestScenarios = new EquatableTestScenarios<Created<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<Created<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Created<Version>[]
                    {
                        new Created<Version>(
                                ReferenceObjectForEquatableTestScenarios.CreatedObject),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new Created<Version>[]
                    {
                        new Created<Version>(
                                A.Dummy<Created<Version>>().Whose(_ => !_.CreatedObject.IsEqualTo(ReferenceObjectForEquatableTestScenarios.CreatedObject)).CreatedObject),
                    },
        ...
        public static class Structural
        {
            ...
            public static void Created___Should_implement_IModel_of_Created___When_reflecting()
            {
                // Arrange
                var type = typeof(Created<Version>);

                var expectedModelMethods = typeof(IModel<Created<Version>>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Created<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Created___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(Created<Version>);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Created<Version>)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "CreatedObject" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Created<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(Created<Version>).GetProperty(propertyName);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<Created<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                Created<Version> systemUnderTest1 = null;
                Created<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    Created<Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Created___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Created___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Created___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Created___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Created___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
