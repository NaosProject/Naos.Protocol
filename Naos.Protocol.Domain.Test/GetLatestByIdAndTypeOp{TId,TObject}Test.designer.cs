...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<GetLatestByIdAndTypeOp<Version, Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<GetLatestByIdAndTypeOp<Version, Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<GetLatestByIdAndTypeOp<Version, Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<GetLatestByIdAndTypeOp<Version, Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<GetLatestByIdAndTypeOp<Version, Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.GetLatestByIdAndTypeOp<Version, Version>: Id = {systemUnderTest.Id?.ToString() ?? "<null>"}, TypeVersionMatchStrategy = {systemUnderTest.TypeVersionMatchStrategy.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<GetLatestByIdAndTypeOp<Version, Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<GetLatestByIdAndTypeOp<Version, Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<GetLatestByIdAndTypeOp<Version, Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'id' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<GetLatestByIdAndTypeOp<Version, Version>>();

                        var result = new GetLatestByIdAndTypeOp<Version, Version>(
                                             null,
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<GetLatestByIdAndTypeOp<Version, Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<GetLatestByIdAndTypeOp<Version, Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<GetLatestByIdAndTypeOp<Version, Version>>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<GetLatestByIdAndTypeOp<Version, Version>>
                        {
                            SystemUnderTest = new GetLatestByIdAndTypeOp<Version, Version>(
                                                      referenceObject.Id,
                                                      referenceObject.TypeVersionMatchStrategy),
        ...
        private static readonly DeepCloneWithTestScenarios<GetLatestByIdAndTypeOp<Version, Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<GetLatestByIdAndTypeOp<Version, Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetLatestByIdAndTypeOp<Version, Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetLatestByIdAndTypeOp<Version, Version>>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<GetLatestByIdAndTypeOp<Version, Version>>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetLatestByIdAndTypeOp<Version, Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetLatestByIdAndTypeOp<Version, Version>>().ThatIs(_ => !systemUnderTest.TypeVersionMatchStrategy.IsEqualTo(_.TypeVersionMatchStrategy));
        ...
        private static readonly GetLatestByIdAndTypeOp<Version, Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<GetLatestByIdAndTypeOp<Version, Version>>();

        private static readonly EquatableTestScenarios<GetLatestByIdAndTypeOp<Version, Version>> EquatableTestScenarios = new EquatableTestScenarios<GetLatestByIdAndTypeOp<Version, Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<GetLatestByIdAndTypeOp<Version, Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new GetLatestByIdAndTypeOp<Version, Version>[]
                    {
                        new GetLatestByIdAndTypeOp<Version, Version>(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.TypeVersionMatchStrategy),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new GetLatestByIdAndTypeOp<Version, Version>[]
                    {
                        new GetLatestByIdAndTypeOp<Version, Version>(
                                A.Dummy<GetLatestByIdAndTypeOp<Version, Version>>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.TypeVersionMatchStrategy),
                        new GetLatestByIdAndTypeOp<Version, Version>(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<GetLatestByIdAndTypeOp<Version, Version>>().Whose(_ => !_.TypeVersionMatchStrategy.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TypeVersionMatchStrategy)).TypeVersionMatchStrategy),
                    },
        ...
        public static class Structural
        {
            ...
            public static void GetLatestByIdAndTypeOp___Should_implement_IModel_of_GetLatestByIdAndTypeOp___When_reflecting()
            {
                // Arrange
                var type = typeof(GetLatestByIdAndTypeOp<Version, Version>);

                var expectedModelMethods = typeof(IModel<GetLatestByIdAndTypeOp<Version, Version>>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<GetLatestByIdAndTypeOp<Version, Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void GetLatestByIdAndTypeOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(GetLatestByIdAndTypeOp<Version, Version>);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (GetLatestByIdAndTypeOp<Version, Version>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (GetLatestByIdAndTypeOp<Version, Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(GetLatestByIdAndTypeOp<Version, Version>).GetProperty(propertyName);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<GetLatestByIdAndTypeOp<Version, Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                GetLatestByIdAndTypeOp<Version, Version> systemUnderTest1 = null;
                GetLatestByIdAndTypeOp<Version, Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    GetLatestByIdAndTypeOp<Version, Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetLatestByIdAndTypeOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetLatestByIdAndTypeOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetLatestByIdAndTypeOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetLatestByIdAndTypeOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetLatestByIdAndTypeOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
