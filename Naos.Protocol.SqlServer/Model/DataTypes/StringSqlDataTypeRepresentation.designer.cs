...
namespace Naos.Protocol.SqlServer
{
    ...
    public partial class StringSqlDataTypeRepresentation : IModel<StringSqlDataTypeRepresentation>
    {
        ...
        {
            var result = Invariant($"Naos.Protocol.SqlServer.StringSqlDataTypeRepresentation: SupportUnicode = {this.SupportUnicode.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, SupportedLength = {this.SupportedLength.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
