...
namespace Naos.Protocol.Domain
{
    ...
    public class SerializableMemberAssignment : SerializableMemberBindingBase
    {
        ...
        public SerializableMemberAssignment(TypeDescription type, string memberHash, SerializableExpressionBase expression)
    ...
    public static class SerializableMemberAssignmentExtensions
    {
        ...
        public static SerializableMemberAssignment ToSerializable(this MemberAssignment memberAssignment)
        {
            var type = memberAssignment.Member.DeclaringType.ToTypeDescription();
            var expression = memberAssignment.Expression.ToSerializable();
        ...
        public static MemberAssignment FromSerializable(this SerializableMemberAssignment memberAssignment)
        {
            ...
            var expression = memberAssignment.Expression.FromSerializable();
