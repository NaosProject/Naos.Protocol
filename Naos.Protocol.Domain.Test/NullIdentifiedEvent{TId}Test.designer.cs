...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<NullIdentifiedEvent<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<NullIdentifiedEvent<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<NullIdentifiedEvent<Version>>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<NullIdentifiedEvent<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<NullIdentifiedEvent<Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<NullIdentifiedEvent<Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'id' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<NullIdentifiedEvent<Version>>();

                        var result = new NullIdentifiedEvent<Version>(
                                             null,
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<NullIdentifiedEvent<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<NullIdentifiedEvent<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<NullIdentifiedEvent<Version>>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<NullIdentifiedEvent<Version>>
                        {
                            SystemUnderTest = new NullIdentifiedEvent<Version>(
                                                      referenceObject.Id,
                                                      referenceObject.TimestampUtc),
        ...
        private static readonly DeepCloneWithTestScenarios<NullIdentifiedEvent<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<NullIdentifiedEvent<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<NullIdentifiedEvent<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<NullIdentifiedEvent<Version>>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));
        ...
        private static readonly NullIdentifiedEvent<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<NullIdentifiedEvent<Version>>();

        private static readonly EquatableTestScenarios<NullIdentifiedEvent<Version>> EquatableTestScenarios = new EquatableTestScenarios<NullIdentifiedEvent<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<NullIdentifiedEvent<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new NullIdentifiedEvent<Version>[]
                    {
        ...
        public static class Structural
        {
            ...
            public static void NullIdentifiedEvent___Should_implement_IModel_of_NullIdentifiedEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(NullIdentifiedEvent<Version>);

                var expectedModelMethods = typeof(IModel<NullIdentifiedEvent<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<NullIdentifiedEvent<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void NullIdentifiedEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(NullIdentifiedEvent<Version>);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (NullIdentifiedEvent<Version>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (NullIdentifiedEvent<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(NullIdentifiedEvent<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<NullIdentifiedEvent<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                NullIdentifiedEvent<Version> systemUnderTest1 = null;
                NullIdentifiedEvent<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    NullIdentifiedEvent<Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NullIdentifiedEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NullIdentifiedEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NullIdentifiedEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NullIdentifiedEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NullIdentifiedEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
