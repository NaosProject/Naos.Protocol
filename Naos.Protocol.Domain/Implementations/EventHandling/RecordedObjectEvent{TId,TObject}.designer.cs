...
namespace Naos.Protocol.Domain
{
    ...
    public partial class RecordedObjectEvent<TId, TObject> : IModel<RecordedObjectEvent<TId, TObject>>
    {
        ...
        {
            var result = Invariant($"Naos.Protocol.Domain.{this.GetType().ToStringReadable()}: Id = {this.Id?.ToString() ?? "<null>"}, Tags = {this.Tags?.ToString() ?? "<null>"}, TimestampUtc = {this.TimestampUtc.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, CreatedObject = {this.CreatedObject?.ToString() ?? "<null>"}.");
