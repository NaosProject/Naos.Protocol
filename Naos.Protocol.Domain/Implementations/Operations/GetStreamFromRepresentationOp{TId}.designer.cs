...
namespace Naos.Protocol.Domain
{
    ...
    public partial class GetStreamFromRepresentationOp<TId> : IModel<GetStreamFromRepresentationOp<TId>>
    {
        ...
        /// <inheritdoc />
        protected override ReturningOperationBase<IStream<TId>> DeepCloneInternal()
        {
            var result = new GetStreamFromRepresentationOp<TId>(
        ...
        {
            var result = Invariant($"Naos.Protocol.Domain.{this.GetType().ToStringReadable()}: StreamRepresentation = {this.StreamRepresentation?.ToString() ?? "<null>"}.");
