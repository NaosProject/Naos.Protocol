...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<GetResourceLocatorByIdOp<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<GetResourceLocatorByIdOp<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<GetResourceLocatorByIdOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<GetResourceLocatorByIdOp<Version>>();
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<GetResourceLocatorByIdOp<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<GetResourceLocatorByIdOp<Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<GetResourceLocatorByIdOp<Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'id' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new GetResourceLocatorByIdOp<Version>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<GetResourceLocatorByIdOp<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<GetResourceLocatorByIdOp<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<GetResourceLocatorByIdOp<Version>>
                {
                    Name = "Id should return same 'id' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<GetResourceLocatorByIdOp<Version>>();

                        var result = new SystemUnderTestExpectedPropertyValue<GetResourceLocatorByIdOp<Version>>
                        {
                            SystemUnderTest = new GetResourceLocatorByIdOp<Version>(
                                                      referenceObject.Id),
        ...
        private static readonly DeepCloneWithTestScenarios<GetResourceLocatorByIdOp<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<GetResourceLocatorByIdOp<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetResourceLocatorByIdOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetResourceLocatorByIdOp<Version>>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<GetResourceLocatorByIdOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly GetResourceLocatorByIdOp<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<GetResourceLocatorByIdOp<Version>>();

        private static readonly EquatableTestScenarios<GetResourceLocatorByIdOp<Version>> EquatableTestScenarios = new EquatableTestScenarios<GetResourceLocatorByIdOp<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<GetResourceLocatorByIdOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new GetResourceLocatorByIdOp<Version>[]
                    {
                        new GetResourceLocatorByIdOp<Version>(
                                ReferenceObjectForEquatableTestScenarios.Id),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new GetResourceLocatorByIdOp<Version>[]
                    {
                        new GetResourceLocatorByIdOp<Version>(
                                A.Dummy<GetResourceLocatorByIdOp<Version>>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id),
                    },
        ...
        public static class Structural
        {
            ...
            public static void GetResourceLocatorByIdOp___Should_implement_IModel_of_GetResourceLocatorByIdOp___When_reflecting()
            {
                // Arrange
                var type = typeof(GetResourceLocatorByIdOp<Version>);

                var expectedModelMethods = typeof(IModel<GetResourceLocatorByIdOp<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<GetResourceLocatorByIdOp<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void GetResourceLocatorByIdOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(GetResourceLocatorByIdOp<Version>);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (GetResourceLocatorByIdOp<Version>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (GetResourceLocatorByIdOp<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(GetResourceLocatorByIdOp<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<GetResourceLocatorByIdOp<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                GetResourceLocatorByIdOp<Version> systemUnderTest1 = null;
                GetResourceLocatorByIdOp<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    GetResourceLocatorByIdOp<Version> systemUnderTest = null;
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_null()
            {
                ...
                {
                    // Arrange
                    ReturningOperationBase<IResourceLocator> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<IResourceLocator>)systemUnderTest);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_parameter_other_is_same_object()
            {
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<IResourceLocator>)scenario.ReferenceObject);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IResourceLocator>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IResourceLocator>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IResourceLocator>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetResourceLocatorByIdOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetResourceLocatorByIdOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetResourceLocatorByIdOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetResourceLocatorByIdOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetResourceLocatorByIdOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
