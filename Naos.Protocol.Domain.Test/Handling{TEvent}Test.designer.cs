...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Handling<Block>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Handling<Block>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Handling<Block>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Handling<Block>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Handling<Block>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.Handling<Block>: HandledEvent = {systemUnderTest.HandledEvent?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Handling<Block>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Handling<Block>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Handling<Block>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'handledEvent' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new Handling<Block>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Handling<Block>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Handling<Block>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Handling<Block>>
                {
                    Name = "HandledEvent should return same 'handledEvent' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Handling<Block>>();

                        var result = new SystemUnderTestExpectedPropertyValue<Handling<Block>>
                        {
                            SystemUnderTest = new Handling<Block>(
        ...
        private static readonly DeepCloneWithTestScenarios<Handling<Block>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Handling<Block>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Handling<Block>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Handling<Block>>().ThatIs(_ => !systemUnderTest.HandledEvent.IsEqualTo(_.HandledEvent));

                        var result = new SystemUnderTestDeepCloneWithValue<Handling<Block>>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly Handling<Block> ReferenceObjectForEquatableTestScenarios = A.Dummy<Handling<Block>>();

        private static readonly EquatableTestScenarios<Handling<Block>> EquatableTestScenarios = new EquatableTestScenarios<Handling<Block>>()
            .AddScenario(() =>
                new EquatableTestScenario<Handling<Block>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Handling<Block>[]
                    {
                        new Handling<Block>(
                                ReferenceObjectForEquatableTestScenarios.HandledEvent),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new Handling<Block>[]
                    {
                        new Handling<Block>(
                                A.Dummy<Handling<Block>>().Whose(_ => !_.HandledEvent.IsEqualTo(ReferenceObjectForEquatableTestScenarios.HandledEvent)).HandledEvent),
                    },
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(Handling<Block>);

                var expectedModelMethods = typeof(IModel<Handling<Block>>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Handling<Block>>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Handling<Block>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Handling<Block>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(Handling<Block>).GetProperty(propertyName);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<Handling<Block>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                Handling<Block> systemUnderTest1 = null;
                Handling<Block> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    Handling<Block> systemUnderTest = null;
