...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<HandleEventOp<Block>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<HandleEventOp<Block>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<HandleEventOp<Block>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<HandleEventOp<Block>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<HandleEventOp<Block>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.HandleEventOp<Block>: EventToHandle = {systemUnderTest.EventToHandle?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<HandleEventOp<Block>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<HandleEventOp<Block>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<HandleEventOp<Block>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'eventToHandle' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new HandleEventOp<Block>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<HandleEventOp<Block>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<HandleEventOp<Block>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<HandleEventOp<Block>>
                {
                    Name = "EventToHandle should return same 'eventToHandle' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<HandleEventOp<Block>>();

                        var result = new SystemUnderTestExpectedPropertyValue<HandleEventOp<Block>>
                        {
                            SystemUnderTest = new HandleEventOp<Block>(
        ...
        private static readonly DeepCloneWithTestScenarios<HandleEventOp<Block>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<HandleEventOp<Block>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<HandleEventOp<Block>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<HandleEventOp<Block>>().ThatIs(_ => !systemUnderTest.EventToHandle.IsEqualTo(_.EventToHandle));

                        var result = new SystemUnderTestDeepCloneWithValue<HandleEventOp<Block>>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly HandleEventOp<Block> ReferenceObjectForEquatableTestScenarios = A.Dummy<HandleEventOp<Block>>();

        private static readonly EquatableTestScenarios<HandleEventOp<Block>> EquatableTestScenarios = new EquatableTestScenarios<HandleEventOp<Block>>()
            .AddScenario(() =>
                new EquatableTestScenario<HandleEventOp<Block>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new HandleEventOp<Block>[]
                    {
                        new HandleEventOp<Block>(
                                ReferenceObjectForEquatableTestScenarios.EventToHandle),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new HandleEventOp<Block>[]
                    {
                        new HandleEventOp<Block>(
                                A.Dummy<HandleEventOp<Block>>().Whose(_ => !_.EventToHandle.IsEqualTo(ReferenceObjectForEquatableTestScenarios.EventToHandle)).EventToHandle),
                    },
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(HandleEventOp<Block>);

                var expectedModelMethods = typeof(IModel<HandleEventOp<Block>>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<HandleEventOp<Block>>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (HandleEventOp<Block>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (HandleEventOp<Block>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(HandleEventOp<Block>).GetProperty(propertyName);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<HandleEventOp<Block>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                HandleEventOp<Block> systemUnderTest1 = null;
                HandleEventOp<Block> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    HandleEventOp<Block> systemUnderTest = null;
