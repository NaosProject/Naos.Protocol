...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ClearCacheOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ClearCacheOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ClearCacheOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ClearCacheOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<ClearCacheOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.ClearCacheOp: <no properties>."),
                        };
        ...
        private static readonly ClearCacheOp ReferenceObjectForEquatableTestScenarios = A.Dummy<ClearCacheOp>();

        private static readonly EquatableTestScenarios<ClearCacheOp> EquatableTestScenarios = new EquatableTestScenarios<ClearCacheOp>()
            .AddScenario(() =>
                new EquatableTestScenario<ClearCacheOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ClearCacheOp[]
                    {
                        new ClearCacheOp(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ClearCacheOp[]
                    {
                    },
        ...
        public static class Structural
        {
            ...
            public static void ClearCacheOp___Should_implement_IModel_of_ClearCacheOp___When_reflecting()
            {
                // Arrange
                var type = typeof(ClearCacheOp);

                var expectedModelMethods = typeof(IModel<ClearCacheOp>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ClearCacheOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ClearCacheOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ClearCacheOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ClearCacheOp)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ClearCacheOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                ClearCacheOp systemUnderTest1 = null;
                ClearCacheOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ClearCacheOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ClearCacheOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ClearCacheOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ClearCacheOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ClearCacheOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ClearCacheOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
