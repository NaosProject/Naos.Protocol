...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Handled<CancelBlock>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Handled<CancelBlock>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Handled<CancelBlock>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Handled<CancelBlock>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Handled<CancelBlock>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.Handled<CancelBlock>: HandledEvent = {systemUnderTest.HandledEvent?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Handled<CancelBlock>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Handled<CancelBlock>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Handled<CancelBlock>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'handledEvent' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new Handled<CancelBlock>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Handled<CancelBlock>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Handled<CancelBlock>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Handled<CancelBlock>>
                {
                    Name = "HandledEvent should return same 'handledEvent' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Handled<CancelBlock>>();

                        var result = new SystemUnderTestExpectedPropertyValue<Handled<CancelBlock>>
                        {
                            SystemUnderTest = new Handled<CancelBlock>(
        ...
        private static readonly DeepCloneWithTestScenarios<Handled<CancelBlock>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Handled<CancelBlock>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Handled<CancelBlock>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Handled<CancelBlock>>().ThatIs(_ => !systemUnderTest.HandledEvent.IsEqualTo(_.HandledEvent));

                        var result = new SystemUnderTestDeepCloneWithValue<Handled<CancelBlock>>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly Handled<CancelBlock> ReferenceObjectForEquatableTestScenarios = A.Dummy<Handled<CancelBlock>>();

        private static readonly EquatableTestScenarios<Handled<CancelBlock>> EquatableTestScenarios = new EquatableTestScenarios<Handled<CancelBlock>>()
            .AddScenario(() =>
                new EquatableTestScenario<Handled<CancelBlock>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Handled<CancelBlock>[]
                    {
                        new Handled<CancelBlock>(
                                ReferenceObjectForEquatableTestScenarios.HandledEvent),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new Handled<CancelBlock>[]
                    {
                        new Handled<CancelBlock>(
                                A.Dummy<Handled<CancelBlock>>().Whose(_ => !_.HandledEvent.IsEqualTo(ReferenceObjectForEquatableTestScenarios.HandledEvent)).HandledEvent),
                    },
        ...
        public static class Structural
        {
            ...
            public static void Handled___Should_implement_IModel_of_Handled___When_reflecting()
            {
                // Arrange
                var type = typeof(Handled<CancelBlock>);

                var expectedModelMethods = typeof(IModel<Handled<CancelBlock>>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Handled<CancelBlock>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Handled___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(Handled<CancelBlock>);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Handled<CancelBlock>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Handled<CancelBlock>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(Handled<CancelBlock>).GetProperty(propertyName);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<Handled<CancelBlock>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                Handled<CancelBlock> systemUnderTest1 = null;
                Handled<CancelBlock> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    Handled<CancelBlock> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Handled___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Handled___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Handled___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Handled___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Handled___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
