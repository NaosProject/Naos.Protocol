...
namespace Naos.Protocol.Domain.Test
{
    ...
    public static partial class ThrowIfResourceUnavailableOpTest
    {
        private static readonly StringRepresentationTestScenarios<ThrowIfResourceUnavailableOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ThrowIfResourceUnavailableOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ThrowIfResourceUnavailableOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ThrowIfResourceUnavailableOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<ThrowIfResourceUnavailableOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.ThrowIfResourceUnavailableOp: ResourceLocator = {systemUnderTest.ResourceLocator?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ThrowIfResourceUnavailableOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ThrowIfResourceUnavailableOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ThrowIfResourceUnavailableOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'resourceLocator' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new ThrowIfResourceUnavailableOp(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ThrowIfResourceUnavailableOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ThrowIfResourceUnavailableOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ThrowIfResourceUnavailableOp>
                {
                    Name = "ResourceLocator should return same 'resourceLocator' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ThrowIfResourceUnavailableOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<ThrowIfResourceUnavailableOp>
                        {
                            SystemUnderTest = new ThrowIfResourceUnavailableOp(
        ...
        private static readonly DeepCloneWithTestScenarios<ThrowIfResourceUnavailableOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ThrowIfResourceUnavailableOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ThrowIfResourceUnavailableOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ThrowIfResourceUnavailableOp>().ThatIs(_ => !systemUnderTest.ResourceLocator.IsEqualTo(_.ResourceLocator));

                        var result = new SystemUnderTestDeepCloneWithValue<ThrowIfResourceUnavailableOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly ThrowIfResourceUnavailableOp ReferenceObjectForEquatableTestScenarios = A.Dummy<ThrowIfResourceUnavailableOp>();

        private static readonly EquatableTestScenarios<ThrowIfResourceUnavailableOp> EquatableTestScenarios = new EquatableTestScenarios<ThrowIfResourceUnavailableOp>()
            .AddScenario(() =>
                new EquatableTestScenario<ThrowIfResourceUnavailableOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ThrowIfResourceUnavailableOp[]
                    {
                        new ThrowIfResourceUnavailableOp(
                                ReferenceObjectForEquatableTestScenarios.ResourceLocator),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ThrowIfResourceUnavailableOp[]
                    {
                        new ThrowIfResourceUnavailableOp(
                                A.Dummy<ThrowIfResourceUnavailableOp>().Whose(_ => !_.ResourceLocator.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ResourceLocator)).ResourceLocator),
                    },
        ...
        public static class Structural
        {
            ...
            public static void ThrowIfResourceUnavailableOp___Should_implement_IModel_of_ThrowIfResourceUnavailableOp___When_reflecting()
            {
                // Arrange
                var type = typeof(ThrowIfResourceUnavailableOp);

                var expectedModelMethods = typeof(IModel<ThrowIfResourceUnavailableOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ThrowIfResourceUnavailableOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ThrowIfResourceUnavailableOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ThrowIfResourceUnavailableOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ThrowIfResourceUnavailableOp)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "ResourceLocator" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ThrowIfResourceUnavailableOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ThrowIfResourceUnavailableOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ThrowIfResourceUnavailableOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                ThrowIfResourceUnavailableOp systemUnderTest1 = null;
                ThrowIfResourceUnavailableOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ThrowIfResourceUnavailableOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ThrowIfResourceUnavailableOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ThrowIfResourceUnavailableOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ThrowIfResourceUnavailableOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ThrowIfResourceUnavailableOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ThrowIfResourceUnavailableOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
