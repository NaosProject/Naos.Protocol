// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ExecutedOpEvent{TId,TOperation}Test.cs" company="Naos Project">
...
namespace Naos.Protocol.Domain.Test
{
    ...
    public static partial class ExecutedOpEventTest
    {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1505:AvoidUnmaintainableCode", Justification = NaosSuppressBecause.CA1505_AvoidUnmaintainableCode_DisagreeWithAssessment)]
        static ExecutedOpEventTest()
        {
            ConstructorArgumentValidationTestScenarios.RemoveAllScenarios();
            ConstructorArgumentValidationTestScenarios
               .AddScenario(
                    () =>
                        new ConstructorArgumentValidationTestScenario<ExecutedOpEvent<Version,
                            HandleEventOp<ExecutedOpEvent<Version, GetIdFromObjectOp<Version, Version>>, Version>>>
                        {
                            ...
                            ConstructionFunc = () =>
                                               {
                                                   var referenceObject =
                                                       A.Dummy<ExecutedOpEvent<Version, HandleEventOp<
                                                           ExecutedOpEvent<Version, GetIdFromObjectOp<Version, Version>>, Version>>>();

                                                   var result =
                                                       new ExecutedOpEvent<Version, HandleEventOp<
                                                           ExecutedOpEvent<Version, GetIdFromObjectOp<Version, Version>>, Version>>(
                                                           referenceObject.Id,
