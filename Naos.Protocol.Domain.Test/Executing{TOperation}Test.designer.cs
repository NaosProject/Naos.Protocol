...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Executing<GetAllResourceLocatorsOp>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Executing<GetAllResourceLocatorsOp>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Executing<GetAllResourceLocatorsOp>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Executing<GetAllResourceLocatorsOp>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Executing<GetAllResourceLocatorsOp>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.Executing<GetAllResourceLocatorsOp>: ExecutedOperation = {systemUnderTest.ExecutedOperation?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Executing<GetAllResourceLocatorsOp>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Executing<GetAllResourceLocatorsOp>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Executing<GetAllResourceLocatorsOp>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'executedOperation' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new Executing<GetAllResourceLocatorsOp>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Executing<GetAllResourceLocatorsOp>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Executing<GetAllResourceLocatorsOp>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Executing<GetAllResourceLocatorsOp>>
                {
                    Name = "ExecutedOperation should return same 'executedOperation' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Executing<GetAllResourceLocatorsOp>>();

                        var result = new SystemUnderTestExpectedPropertyValue<Executing<GetAllResourceLocatorsOp>>
                        {
                            SystemUnderTest = new Executing<GetAllResourceLocatorsOp>(
        ...
        private static readonly DeepCloneWithTestScenarios<Executing<GetAllResourceLocatorsOp>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Executing<GetAllResourceLocatorsOp>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Executing<GetAllResourceLocatorsOp>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Executing<GetAllResourceLocatorsOp>>().ThatIs(_ => !systemUnderTest.ExecutedOperation.IsEqualTo(_.ExecutedOperation));

                        var result = new SystemUnderTestDeepCloneWithValue<Executing<GetAllResourceLocatorsOp>>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly Executing<GetAllResourceLocatorsOp> ReferenceObjectForEquatableTestScenarios = A.Dummy<Executing<GetAllResourceLocatorsOp>>();

        private static readonly EquatableTestScenarios<Executing<GetAllResourceLocatorsOp>> EquatableTestScenarios = new EquatableTestScenarios<Executing<GetAllResourceLocatorsOp>>()
            .AddScenario(() =>
                new EquatableTestScenario<Executing<GetAllResourceLocatorsOp>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Executing<GetAllResourceLocatorsOp>[]
                    {
                        new Executing<GetAllResourceLocatorsOp>(
                                ReferenceObjectForEquatableTestScenarios.ExecutedOperation),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new Executing<GetAllResourceLocatorsOp>[]
                    {
                        new Executing<GetAllResourceLocatorsOp>(
                                A.Dummy<Executing<GetAllResourceLocatorsOp>>().Whose(_ => !_.ExecutedOperation.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ExecutedOperation)).ExecutedOperation),
                    },
                    ObjectsThatAreNotOfTheSameTypeAsReferenceObject = new object[]
                    {
                        ...
                        A.Dummy<Executed<GetAllResourceLocatorsOp>>(),
                        A.Dummy<Handled<Block>>(),
                        A.Dummy<Handling<Block>>(),
                        A.Dummy<Pruned>(),
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(Executing<GetAllResourceLocatorsOp>);

                var expectedModelMethods = typeof(IModel<Executing<GetAllResourceLocatorsOp>>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Executing<GetAllResourceLocatorsOp>>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Executing<GetAllResourceLocatorsOp>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Executing<GetAllResourceLocatorsOp>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(Executing<GetAllResourceLocatorsOp>).GetProperty(propertyName);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<Executing<GetAllResourceLocatorsOp>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                Executing<GetAllResourceLocatorsOp> systemUnderTest1 = null;
                Executing<GetAllResourceLocatorsOp> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    Executing<GetAllResourceLocatorsOp> systemUnderTest = null;
