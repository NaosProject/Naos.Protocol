...
namespace Naos.Protocol.Domain
{
    ...
    using global::Naos.Protocol.SqlServer;
    ...
    public partial class GetIdAddIfNecessarySerializerRepresentationOp : IModel<GetIdAddIfNecessarySerializerRepresentationOp>
    {
        ...
        /// <inheritdoc />
        protected override ReturningOperationBase<int> DeepCloneInternal()
        {
            var result = new GetIdAddIfNecessarySerializerRepresentationOp(
                                 this.ResourceLocator?.DeepClone(),
                                 this.SerializerRepresentation?.DeepClone(),
        ...
        {
            var result = Invariant($"Naos.Protocol.Domain.GetIdAddIfNecessarySerializerRepresentationOp: SerializerRepresentation = {this.SerializerRepresentation?.ToString() ?? "<null>"}, SerializationFormat = {this.SerializationFormat.ToString() ?? "<null>"}, ResourceLocator = {this.ResourceLocator?.ToString() ?? "<null>"}.");
