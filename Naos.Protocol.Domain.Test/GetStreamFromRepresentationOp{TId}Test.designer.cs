...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<GetStreamFromRepresentationOp<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<GetStreamFromRepresentationOp<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<GetStreamFromRepresentationOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<GetStreamFromRepresentationOp<Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<GetStreamFromRepresentationOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.GetStreamFromRepresentationOp<Version>: StreamRepresentation = {systemUnderTest.StreamRepresentation?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<GetStreamFromRepresentationOp<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<GetStreamFromRepresentationOp<Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<GetStreamFromRepresentationOp<Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'streamRepresentation' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new GetStreamFromRepresentationOp<Version>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<GetStreamFromRepresentationOp<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<GetStreamFromRepresentationOp<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<GetStreamFromRepresentationOp<Version>>
                {
                    Name = "StreamRepresentation should return same 'streamRepresentation' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<GetStreamFromRepresentationOp<Version>>();

                        var result = new SystemUnderTestExpectedPropertyValue<GetStreamFromRepresentationOp<Version>>
                        {
                            SystemUnderTest = new GetStreamFromRepresentationOp<Version>(
        ...
        private static readonly DeepCloneWithTestScenarios<GetStreamFromRepresentationOp<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<GetStreamFromRepresentationOp<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetStreamFromRepresentationOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetStreamFromRepresentationOp<Version>>().ThatIs(_ => !systemUnderTest.StreamRepresentation.IsEqualTo(_.StreamRepresentation));

                        var result = new SystemUnderTestDeepCloneWithValue<GetStreamFromRepresentationOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly GetStreamFromRepresentationOp<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<GetStreamFromRepresentationOp<Version>>();

        private static readonly EquatableTestScenarios<GetStreamFromRepresentationOp<Version>> EquatableTestScenarios = new EquatableTestScenarios<GetStreamFromRepresentationOp<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<GetStreamFromRepresentationOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new GetStreamFromRepresentationOp<Version>[]
                    {
                        new GetStreamFromRepresentationOp<Version>(
                                ReferenceObjectForEquatableTestScenarios.StreamRepresentation),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new GetStreamFromRepresentationOp<Version>[]
                    {
                        new GetStreamFromRepresentationOp<Version>(
                                A.Dummy<GetStreamFromRepresentationOp<Version>>().Whose(_ => !_.StreamRepresentation.IsEqualTo(ReferenceObjectForEquatableTestScenarios.StreamRepresentation)).StreamRepresentation),
                    },
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(GetStreamFromRepresentationOp<Version>);

                var expectedModelMethods = typeof(IModel<GetStreamFromRepresentationOp<Version>>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<GetStreamFromRepresentationOp<Version>>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (GetStreamFromRepresentationOp<Version>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (GetStreamFromRepresentationOp<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(GetStreamFromRepresentationOp<Version>).GetProperty(propertyName);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<GetStreamFromRepresentationOp<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                GetStreamFromRepresentationOp<Version> systemUnderTest1 = null;
                GetStreamFromRepresentationOp<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    GetStreamFromRepresentationOp<Version> systemUnderTest = null;
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_null()
            {
                ...
                {
                    // Arrange
                    ReturningOperationBase<IStream<Version>> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<IStream<Version>>)systemUnderTest);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_parameter_other_is_same_object()
            {
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<IStream<Version>>)scenario.ReferenceObject);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IStream<Version>>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IStream<Version>>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IStream<Version>>)_)).ToList();
