...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly OperationBase ReferenceObjectForEquatableTestScenarios = A.Dummy<OperationBase>();

        private static readonly EquatableTestScenarios<OperationBase> EquatableTestScenarios = new EquatableTestScenarios<OperationBase>()
            .AddScenario(() =>
                new EquatableTestScenario<OperationBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new OperationBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new OperationBase[]
                    {
                    ...
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new OperationBase[]
                    {
                        A.Dummy<OperationBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void OperationBase___Should_implement_IModel_of_OperationBase___When_reflecting()
            {
                // Arrange
                var type = typeof(OperationBase);

                var expectedModelMethods = typeof(IModel<OperationBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<OperationBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void OperationBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(OperationBase);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<OperationBase>();

                // Act
                var actual = (OperationBase)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<OperationBase>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                OperationBase systemUnderTest1 = null;
                OperationBase systemUnderTest2 = null;
