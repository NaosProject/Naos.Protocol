...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly EventBase<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<EventBase<Version>>();

        private static readonly EquatableTestScenarios<EventBase<Version>> EquatableTestScenarios = new EquatableTestScenarios<EventBase<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<EventBase<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new EventBase<Version>[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new EventBase<Version>[]
                    {
                        ...
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithTags(A.Dummy<EventBase<Version>>().Whose(_ => !_.Tags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Tags)).Tags),
                        // ReferenceObjectForEquatableTestScenarios.DeepCloneWithTimestampUtc(A.Dummy<EventBase<Version>>().Whose(_ => !_.TimestampUtc.IsEqualTo(ReferenceObjectForEquatableTestScenarios.TimestampUtc)).TimestampUtc),
                    },
        ...
        public static class Structural
        {
            ...
            public static void EventBase___Should_implement_IModel_of_EventBase___When_reflecting()
            {
                // Arrange
                var type = typeof(EventBase<Version>);

                var expectedModelMethods = typeof(IModel<EventBase<Version>>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<EventBase<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void EventBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(EventBase<Version>);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<EventBase<Version>>();

                // Act
                var actual = (EventBase<Version>)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<EventBase<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                EventBase<Version> systemUnderTest1 = null;
                EventBase<Version> systemUnderTest2 = null;
