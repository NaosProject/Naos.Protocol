...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CompleteRunningExecutionOp<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CompleteRunningExecutionOp<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CompleteRunningExecutionOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CompleteRunningExecutionOp<Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CompleteRunningExecutionOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.CompleteRunningExecutionOp<Version>: Id = {systemUnderTest.Id?.ToString() ?? "<null>"}, Tags = {systemUnderTest.Tags?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CompleteRunningExecutionOp<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CompleteRunningExecutionOp<Version>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CompleteRunningExecutionOp<Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'id' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CompleteRunningExecutionOp<Version>>();

                        var result = new CompleteRunningExecutionOp<Version>(
                                             null,
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CompleteRunningExecutionOp<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CompleteRunningExecutionOp<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CompleteRunningExecutionOp<Version>>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CompleteRunningExecutionOp<Version>>
                        {
                            SystemUnderTest = new CompleteRunningExecutionOp<Version>(
                                                      referenceObject.Id,
                                                      referenceObject.Tags),
        ...
        private static readonly DeepCloneWithTestScenarios<CompleteRunningExecutionOp<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CompleteRunningExecutionOp<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompleteRunningExecutionOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompleteRunningExecutionOp<Version>>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<CompleteRunningExecutionOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompleteRunningExecutionOp<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompleteRunningExecutionOp<Version>>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
        ...
        private static readonly CompleteRunningExecutionOp<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<CompleteRunningExecutionOp<Version>>();

        private static readonly EquatableTestScenarios<CompleteRunningExecutionOp<Version>> EquatableTestScenarios = new EquatableTestScenarios<CompleteRunningExecutionOp<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<CompleteRunningExecutionOp<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CompleteRunningExecutionOp<Version>[]
                    {
                        new CompleteRunningExecutionOp<Version>(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CompleteRunningExecutionOp<Version>[]
                    {
                        new CompleteRunningExecutionOp<Version>(
                                A.Dummy<CompleteRunningExecutionOp<Version>>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new CompleteRunningExecutionOp<Version>(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<CompleteRunningExecutionOp<Version>>().Whose(_ => !_.Tags.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Tags)).Tags),
                    },
        ...
        public static class Structural
        {
            ...
            public static void CompleteRunningExecutionOp___Should_implement_IModel_of_CompleteRunningExecutionOp___When_reflecting()
            {
                // Arrange
                var type = typeof(CompleteRunningExecutionOp<Version>);

                var expectedModelMethods = typeof(IModel<CompleteRunningExecutionOp<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CompleteRunningExecutionOp<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CompleteRunningExecutionOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CompleteRunningExecutionOp<Version>);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CompleteRunningExecutionOp<Version>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CompleteRunningExecutionOp<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CompleteRunningExecutionOp<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CompleteRunningExecutionOp<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CompleteRunningExecutionOp<Version> systemUnderTest1 = null;
                CompleteRunningExecutionOp<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CompleteRunningExecutionOp<Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompleteRunningExecutionOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompleteRunningExecutionOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompleteRunningExecutionOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompleteRunningExecutionOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompleteRunningExecutionOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
