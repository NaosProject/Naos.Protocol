...
namespace Naos.Protocol.Domain.Test
{
    ...
    {
        private static readonly ResourceLocatorBase ReferenceObjectForEquatableTestScenarios = A.Dummy<ResourceLocatorBase>();

        private static readonly EquatableTestScenarios<ResourceLocatorBase> EquatableTestScenarios = new EquatableTestScenarios<ResourceLocatorBase>()
            .AddScenario(() =>
                new EquatableTestScenario<ResourceLocatorBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ResourceLocatorBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ResourceLocatorBase[]
                    {
                    ...
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new ResourceLocatorBase[]
                    {
                        A.Dummy<ResourceLocatorBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void ResourceLocatorBase___Should_implement_IModel_of_ResourceLocatorBase___When_reflecting()
            {
                // Arrange
                var type = typeof(ResourceLocatorBase);

                var expectedModelMethods = typeof(IModel<ResourceLocatorBase>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ResourceLocatorBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ResourceLocatorBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ResourceLocatorBase);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ResourceLocatorBase>();

                // Act
                var actual = (ResourceLocatorBase)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ResourceLocatorBase>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                ResourceLocatorBase systemUnderTest1 = null;
                ResourceLocatorBase systemUnderTest2 = null;
