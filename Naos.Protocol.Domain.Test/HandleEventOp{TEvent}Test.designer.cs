...
namespace Naos.Protocol.Domain.Test
{
    ...
    public static partial class HandleEventOpTEventTest
    {
        private static readonly StringRepresentationTestScenarios<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Protocol.Domain.HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>: EventToHandle = {systemUnderTest.EventToHandle?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'eventToHandle' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>
                {
                    Name = "EventToHandle should return same 'eventToHandle' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>();

                        var result = new SystemUnderTestExpectedPropertyValue<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>
                        {
                            SystemUnderTest = new HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>(
        ...
        private static readonly DeepCloneWithTestScenarios<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>().ThatIs(_ => !systemUnderTest.EventToHandle.IsEqualTo(_.EventToHandle));

                        var result = new SystemUnderTestDeepCloneWithValue<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>> ReferenceObjectForEquatableTestScenarios = A.Dummy<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>();

        private static readonly EquatableTestScenarios<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>> EquatableTestScenarios = new EquatableTestScenarios<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>()
            .AddScenario(() =>
                new EquatableTestScenario<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>[]
                    {
                        new HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>(
                                A.Dummy<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>().Whose(_ => !_.EventToHandle.IsEqualTo(ReferenceObjectForEquatableTestScenarios.EventToHandle)).EventToHandle),
                    },
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>);

                var expectedModelMethods = typeof(IModel<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>> systemUnderTest1 = null;
                HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    HandleEventOp<ExecuteOperationRequestedEvent<Version, GetProtocolByTypeOp>> systemUnderTest = null;
